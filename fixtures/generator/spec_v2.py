...
def expected_verdict(
    ...
    if currency is not None and currency not in ALLOWED_CURRENCIES:
        return "FAIL"
    if currency is None and ALLOWED_CURRENCIES is not None:
        return "REVIEW"
    if required_missing:
        return "REVIEW"
    return "PASS"
...
POOLS: dict[str, dict] = {
    "EN": {
        ...
        "seeds": (
            ...
            "Station Foods B.V.",
            "Market Optics GmbH",
            "Oakbridge Logistics Ltd",
            "Beacon Manufacturing Inc",
            "Crestline Software Ltd",
            "Union Print Works Ltd",
            "Falcon Freight B.V.",
        ),
        "cities": (
            "Manchester",
        ...
        "table_items": (
            ("Consulting (hours)", 60, 140),
            ("Support retainer (month)", 200, 900),
            ("License seat (year)", 90, 400),
            ("Workshop day", 350, 800),
            ("Hardware unit", 120, 1500),
            ("Freight consignment", 45, 260),
            ("Training seat", 120, 480),
            ("Inspection visit", 150, 600),
            ("Spare part set", 30, 700),
            ("Data export (batch)", 80, 300),
        ),
        "banks": (
            ("Barclays", "BUKGB22"),
            ("NatWest", "NWBKGB2L"),
            ("HSBC", "HBUKGB4B"),
            ("Santander UK", "ABNAGB210"),
            ("Revolut", "REVOGB21"),
        ),
    ...
    "ES": {
        ...
        "seeds": (
            ...
            "Ferretería Montes S.L.",
            "Transportes Ribera S.A.",
            "Panadería Miralvalle S.L.",
            "Estudio Jurídico Alcázar S.L.",
        ...
        "table_items": (
            ("Consultoría (horas)", 35, 90),
            ("Mantenimiento (mes)", 180, 800),
            ("Licencia (año)", 95, 420),
            ("Jornada de formación", 300, 750),
            ("Equipo hardware", 140, 1400),
            ("Transporte envío", 40, 240),
            ("Plaza de curso", 110, 460),
            ("Visita técnica", 130, 550),
            ("Kit de repuestos", 25, 650),
            ("Exportación de datos", 70, 280),
        ),
        "banks": (
            ("Santander", "SANTESMM"),
            ("BBVA", "BBVAESMM"),
...
TXT_PLAN: list[dict] = [
    ...
    *[
    ...
    ],
    {
        ...
        "lang": "EN",
        "tier": 0,
        "scenario": {"kind": "stale", "age_days": 150},
        "currency": "GBP",
    },
    *[
        {
        ...
        for i, c in enumerate(("EUR", "GBP", "EUR", "GBP", "EUR"))
    ],
    {
        "case_id": "t1_en_5",
        "lang": "EN",
        "tier": 1,
        "scenario": {"kind": "zero_amount", "amount": 0.0, "age_days": 10},
        "currency": "EUR",
    },
    {
        "case_id": "t1_en_6",
        "lang": "EN",
        "tier": 1,
        "scenario": {"kind": "stale_just_over", "age_days": 91},
        "currency": "EUR",
    },
    {
        "case_id": "t1_en_7",
    ...
    },
    {
        ...
        "lang": "EN",
        "tier": 2,
        "scenario": {"kind": "clean", "currency_markers": "none"},
        "currency": "EUR",
    },
    *[
        {
    ...
    },
    {
        ...
        "lang": "EN",
        "tier": 2,
        "scenario": {"kind": "stale_old", "age_days": 240},
        "currency": "EUR",
    },
    {
        "case_id": "t2_en_5",
...
PDF_PLAN: list[dict] = [
    # --- EN: 3 t0 / 4 t1 / 3 t2 (single page) -----------------------------------
    {
        ...
        "tier": 0,
        "layout": "basic",
        "scenario": {"kind": "clean", "age_days": 15},
        "currency": "EUR",
    },
    {
        "case_id": "pdf_en_t0_1",
        ...
        "tier": 0,
        "layout": "basic",
        "scenario": {"kind": "clean", "age_days": 40},
        "currency": "GBP",
    },
    {
        "case_id": "pdf_en_t0_2",
        ...
        "tier": 0,
        "layout": "basic",
        "scenario": {"kind": "stale", "age_days": 180},
        "currency": "EUR",
    },
    {
        "case_id": "pdf_en_t1_0",
        ...
        "tier": 1,
        "layout": "styled",
        "scenario": {"kind": "clean", "age_days": 20},
        "currency": "EUR",
    },
    {
        "case_id": "pdf_en_t1_1",
        ...
        "tier": 1,
        "layout": "styled",
        "scenario": {"kind": "clean", "age_days": 60},
        "currency": "GBP",
    },
    {
        "case_id": "pdf_en_t1_2",
        ...
        "tier": 1,
        "layout": "styled",
        "scenario": {"kind": "clean", "age_days": 25},
        "currency": "EUR",
    },
    {
        "case_id": "pdf_en_t1_3",
        ...
        "tier": 1,
        "layout": "styled",
        "scenario": {"kind": "missing_date", "drop": "date", "age_days": 10},
        "currency": "EUR",
    },
    {
        "case_id": "pdf_en_t2_0",
        ...
        "tier": 2,
        "layout": "complex",
        "scenario": {"kind": "clean", "age_days": 30},
        "currency": "EUR",
    },
    {
        "case_id": "pdf_en_t2_1",
        ...
        "tier": 2,
        "layout": "complex",
        "scenario": {"kind": "clean", "currency_markers": "none", "age_days": 25},
        "currency": "GBP",
    },
    {
        "case_id": "pdf_en_t2_2",
    ...
    # --- ES: 3 t0 / 4 t1 / 3 t2 (single page) -----------------------------------
    {
        ...
        "tier": 0,
        "layout": "basic",
        "scenario": {"kind": "clean", "age_days": 12},
        "currency": "EUR",
    },
    {
        "case_id": "pdf_es_t0_1",
        ...
        "tier": 0,
        "layout": "basic",
        "scenario": {"kind": "clean", "age_days": 55},
        "currency": "GBP",
    },
    {
        "case_id": "pdf_es_t0_2",
        ...
        "tier": 0,
        "layout": "basic",
        "scenario": {"kind": "stale", "age_days": 210},
        "currency": "EUR",
    },
    {
        "case_id": "pdf_es_t1_0",
    ...
    },
    {
        ...
        "tier": 1,
        "layout": "styled",
        "scenario": {"kind": "clean", "age_days": 70},
        "currency": "GBP",
    },
    {
        "case_id": "pdf_es_t1_2",
        ...
        "tier": 1,
        "layout": "styled",
        "scenario": {"kind": "clean", "age_days": 33},
        "currency": "EUR",
    },
    {
        "case_id": "pdf_es_t1_3",
    ...
    },
    {
        ...
        "tier": 2,
        "layout": "complex",
        "scenario": {"kind": "clean", "age_days": 18},
        "currency": "EUR",
    },
    {
        "case_id": "pdf_es_t2_1",
        ...
        "tier": 2,
        "layout": "complex",
        "scenario": {"kind": "clean", "currency_markers": "none", "age_days": 45},
        "currency": "GBP",
    },
    {
        "case_id": "pdf_es_t2_2",
...
DEGENERATE_TXT_PLAN: list[dict] = [
    ...
    {
        "case_id": "x_txt_no_vat",
        "lang": "ES",
        "tier": 0,
        "scenario": {"kind": "clean", "no_vat": True, "age_days": 12},
        "currency": "EUR",
    },
]
DEGENERATE_PDF_PLAN: list[dict] = [
    ...
    {
        "case_id": "x_pdf_no_vat",
        "lang": "EN",
        "tier": 1,
        "layout": "styled",
        "scenario": {"kind": "clean", "no_vat": True, "age_days": 20},
        "currency": "EUR",
    },
]
